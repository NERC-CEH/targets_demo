...
author: Peter Levy (with some slides of Will Landau)
output: 
...
## Typical Workflow: interconnected tasks
...
## Pipeline tools figure out what to rerun.
...
- Includes both code and text in markdown/LaTeX
